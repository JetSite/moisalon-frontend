...
const CabinetChat = ({ me }) => {
  ...
  const chatClickHandler = (chatData) => {
            ...
            <Link
              href={`/${cyrToTranslit(
                chatClicked?.chat?.origin === "MASTER"
                  ? chatClicked?.originData?.addressFull?.city
                  : chatClicked?.originData?.address?.city || city
              )}/${
                chatClicked?.chat?.origin === "MASTER" ? "master" : "salon"
              }/${
                chatClicked?.originData?.seo?.slug ||
