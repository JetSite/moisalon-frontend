...
export default function getMainPageHeaderLinks(
  ...
  const addNavLinks: IMainPageHeaderLinks[] = [
    ...
    { title: 'Акции', link: '/sales', target: '_self', disabled: false },
    {
      title: 'Обучение',
      link: '/educations',
      target: '_self',
    ...
    { title: 'Мероприятия', link: '/events', target: '_self', disabled: false },
    { title: 'Вакансии', link: '/vacancies', target: '_self', disabled: false },
    { title: 'Новости', link: '/advices', target: '_self', disabled: false },
    // {
    //   title: 'Тренды',
    //   link: '/trends',
    //   target: '_self',
